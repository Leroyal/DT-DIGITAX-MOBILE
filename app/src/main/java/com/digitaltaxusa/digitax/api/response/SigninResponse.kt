...
data class SigninResponse(
    ...
    private val identifier: EndpointIdentifier = EndpointIdentifier.SIGNIN
) : EmptyStateInfo {
    ...
    companion object {
        ...
        /**
         * An empty object instance for [SigninResponse].
         *
         * If the API were to respond back with a successful response but with an empty body,
         * clients will get back an [EMPTY] instance for [SigninResponse].
         */
        val EMPTY = SigninResponse()
    }
}